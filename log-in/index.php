                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        <div class="log-in-title">
                            <h3>Welcome To HimalayanPutri</h3>
                            <h4>Log In Your Account</h4>
                        </div>

                        <div class="input-box">
                            <form class="row g-4" action="check-login.php" method="post">
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                        <input type="email" class="form-control" id="emailid" name="emailid" value="surenroy@gmail.com" placeholder="Email Address">
    ...
    <footer class="section-t-space">
        <div class="container-fluid-lg">
                            ...
                            <div class="footer-logo-contain">
                                ...
                                <ul class="address">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)">support@HimalayanPutri.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <li>
                                    <div class="footer-number">
                                        ...
                                        <div class="contact-number">
                                            ...
                                            <h5>HimalayanPutri@hotmail.com</h5>
                                        </div>
                                    </div>
                                </li>
            ...
            <div class="sub-footer section-small-space">
                <div class="reserve">
                    <h6 class="text-content">©2022 HimalayanPutri All rights reserved</h6>
                </div>
