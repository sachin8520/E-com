...
$idList = isset($_COOKIE['cartList']) ? $_COOKIE['cartList'] : null;
if ($idList) {
                                    ...
                                    ?>
                                        <tr>
                                            <td class="product-detail">
                                                <div class="product border-0">
                                                    ...
                                                    <div class="product-detail">
                                                        <ul>
                                                            <li class="name">
                                                                <a href="product-left-thumbnail.html"><?= $product['title'] ?></a>
                                                            </li>

                                                            <li class="text-content">Sold By: Fresho</li>

                                                            <li class="text-content">Quantity - <?= $product['quantity'] ?></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="price">
                                                ...
                                                <h6 class="theme-color">$<?= $product['selling_price'] ?></h6>
                                            </td>
                        ...
                        <div class="col-lg-12 col-sm-6">
                            <div class="summery-box">
                                ...
                                <ul class="summery-total">
                                    <li class="list-total">
                                        <h4>Total (USD)</h4>
                                        <h4 class="price">$<?= $totalPrice + 12.23 - 6.27 ?></h4>
                                    </li>
                                </ul>
                            </div>
                        </div>
