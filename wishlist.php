...
$products =  isset($_COOKIE['wishList']) ? json_decode($_COOKIE['wishList']) : [];
// if ($idList != '[]') {
//     $idList = str_replace("[", "(", $idList);
//     $idList = str_replace("]", ")", $idList);
//     $products = $pdo->query("SELECT * from products  where id in " . $idList)->fetchAll(PDO::FETCH_ASSOC);
// } else {
//     $products = [];
// }
                            ...
                            <div class="product-header">
                                <div class="product-image">
                                    <a href="product-left-thumbnail.html">
                                        <img src="<?= "admin/" . $product->image ?>" class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="product-header-top">
                                        <button onclick="removeItem(<?= $index ?>)" class="btn wishlist-button close_button">
                                            <i data-feather="x"></i>
                                        </button>
                                    </div>
                                </div>
